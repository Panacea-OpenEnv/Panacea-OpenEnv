...
def generate_sft_data(output_file="sft_drift_recovery.jsonl", num_examples=75):
    ...
    for i in range(num_examples):
        ...
        # 1. Initial Attempt (Fails due to drift)
        ...
        # 2. Environment returns ProgrammingError
        ...
        # 3. Agent queries Information Schema to recover
        ...
        # 4. Environment returns schema query results
        messages.append({"role": "user", "content": f"Query Result:\n[('{new_table_name}',)]"})
        
        # 5. Agent successfully reissues query
